...
namespace Microsoft.BotBuilderSamples
{
    public class DialogAndWelcomeBot<T> : DialogBot<T> where T : Dialog
    {
        ...
        private const string WelcomeMessage = "Hi, I'm Me2. I'm here to help you with any issues related to sexual harassment.";
            ...
            CancellationToken cancellationToken)
        {
            foreach (var member in membersAdded)
            {
                if (member.Id != turnContext.Activity.Recipient.Id)
                {
                    ...
                    await turnContext.SendActivityAsync("Type anything to start the bot:", cancellationToken: cancellationToken);
                }
            }
        }
    }     
